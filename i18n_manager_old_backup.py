...
A beautiful, modern tool for managing translations in React/TypeScript projects
Features Discord-like UI with dark mode and smooth animations
...
class I18nManagerApp:
    """Modern, standalone i18n Manager application with Discord-like UI"""
    
    # Modern color scheme (adjusted for dark mode)
    COLORS = {
        'primary': ('#3b82f6', '#2563eb'),  # (hover, normal)
    ...
    def __init__(self, root):
        ...
        # Comment this line if you want standard window controls
