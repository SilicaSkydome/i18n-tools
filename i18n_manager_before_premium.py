...
class I18nManagerApp:
    ...
    COLORS = {
        ...
        'accent_blue': '#0078d4',         # Windows 11 blue
        'accent_blue_hover': '#106ebe',   # Darker blue
        'glass_bg': '#1e2936',            # Glass background
        'glass_border': '#30363d',        # Glass border
    ...
    def create_left_panel(self, parent):
        ...
        scroll = ctk.CTkScrollableFrame(
            ...
            scrollbar_button_hover_color=self.COLORS['accent_blue_hover']
        )
        ...
        # Separator
        sep = ctk.CTkFrame(scroll, height=1, fg_color=self.COLORS['glass_border'])
    ...
    def create_step_btn(self, parent, text, command):
        ...
        btn = ctk.CTkButton(
            ...
            corner_radius=8,
            fg_color=self.COLORS['bg_card'],
            hover_color=self.COLORS['glass_border'],
            border_width=1,
            border_color=self.COLORS['glass_border'],
            font=ctk.CTkFont(size=12),
            state="disabled"
